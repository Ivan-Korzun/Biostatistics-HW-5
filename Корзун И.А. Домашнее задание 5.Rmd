...
logistic_model4 <- glm(diagnosis ~ texture_mean + area_mean + symmetry_mean, data = df)
...
Модель, использующая все 3 переменные, является наиболее точной. Но вопрос о ее генерализации на новых данных остается открытым. 
